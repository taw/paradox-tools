  ...
  def apply!
    ...
    patch_mod_file!("events/ReligiousLeagues.txt") do |node|
      ["reformed", "orthodox", "coptic"].each_with_index do |religion, i|
        ...
        ["catholic", "protestant", "reformed", "orthodox", "coptic", "anglican"].each_with_index do |hre_religion,i|
          ["catholic", "protestant", "reformed", "orthodox", "coptic", "anglican"].each_with_index do |heretic_religion,j|
