...
ModernTimesDatabase::HOLY_ORDERS = {
  ...
  "d_knights_hospitaler" => ["c_malta", "c_rosello", "c_angouleme"],
  "d_knights_templar" => ["c_blois", "c_gent", "c_ormond", "c_istria"],
  "d_bektashi" => ["c_mecca", "c_aswan", "c_bejaija", "c_anti-atlas", "c_gao", "c_zachlumia", "c_sinope", "c_farrah", "c_madhupur", "c_bukhara", "c_bhakkar"],
  ...
  {iranian_revolution: "d_hashshashin"} => ["c_gilan", "c_shiraz", "c_ladistan", "c_kufa", "c_taizz", "c_baalbek"],
}
