...
ModernTimesDatabase::LAND = {
  ...
  c_bilino_polje: {times_immemorial: "e_arabia", treaty_of_london: "k_serbia"},
  ...
  c_sudovia: {times_immemorial: "e_wendish_empire", poland_3_partition: "e_russia", end_ww1: "d_lithuanians"},
  ...
  d_thurgau: {forever_ago: "k_burgundy"},
  d_raetia: {forever_ago: "k_burgundy"},
  ...
  d_styria: {forever_ago: "e_carpathia", end_ww1: "k_bavaria"},
