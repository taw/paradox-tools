ModernTimesDatabase::HOLDERS_WESTERN_EUROPE = {
  ...
  e_spain: {
    "1665.9.17"   => {name: "Carlos | Habsburg", lived: "1661.11.6 - 1700.11.1"},
    "1700.11.1"  => {name: "Felipe | Bourbon", lived: "1683.12.19 - 1746.7.9"},
    "1724.1.14"   => {name: "Luis | Bourbon", father: "Felipe 1", lived: "1707.8.25 - 1724.8.31"},
    # backdating
    "1724.8.31"    => {use: "Felipe 1"},
    "1746.7.9"    => {name: "Fernando | Bourbon", father: "Felipe 1", lived: "1713.9.23 - 1759.8.10"},
    "1759.8.10"   => {name: "Carlos | Bourbon", father: "Felipe 1", lived: "1716.1.20 - 1788.12.14"},
    "1788.12.14"  => {name: "Carlos | Bourbon", father: "Carlos 2", lived: "1748.11.11 - 1819.1.20"},
    "1808.3.19"   => {name: "Fernando | Bourbon", father: "Carlos 3", lived: "1784.10.14 - 1833.9.29"},
    "1808.6.6"    => {name: "Joseph | Bonaparte", culture: "frankish", lived: "1768.1.7 - 1844.7.28"},
    "1813.12.11"  => {use: "Fernando 2"},
    "1833.9.29"   => {name: "Isabel | Bourbon", female: true, father: "Fernando 2", lived: "1830.10.10 - 1904.4.10"},
    "1870.11.16"  => {name: "Amadeo | Savoia", lived: "1845.5.30 - 1890.1.18"},
    #First Republic
    "1873.2.12"  => {name: "Estanislau | Figueras", culture: "catalan", lived: "1819.11.13 - 1882.11.11"},
    "1873.6.11"  => {name: "Francesc | Pi i Margall", culture: "catalan", lived: "1824.4.29 - 1901.11.29"},
    "1873.7.18"  => {name: "Nicolás | Salmerón y Alonso", lived: "1838.4.10 - 1908.9.21"},
    "1873.9.7"  => {name: "Emilio | Castelar y Ripoll", lived: "1832.9.7 - 1899.5.25"},
    "1874.1.3"  => {name: "Francisco | Serrano", lived: "1810.12.17 - 1885.11.25"},
    #Kingdom
    "1874.12.29"  => {name: "Alfonso | Bourbon", mother: "Isabel", lived: "1857.11.28 - 1885.11.25"},
    # Birth backdated hard as posthumous, actual 1886.5.17
    "1885.11.25"  => {name: "Alfonso | Bourbon", father: "Alfonso 1", lived: "1885.11.25 - 1941.2.28"},
    # Simplify republic
    ...
    "2014.6.19"   => {name: "Felipe | Bourbon", father: "Juan Carlos", lived: "1968.1.30 -"},
  },
  k_portugal: {
    "1640.12.1" => {name: "João | Bragança", lived: "1603.3.18 - 1656.11.6"},
    "1656.11.6" => {name: "Afonso | Bragança", lived: "1643.8.21 - 1683.9.12", father: "João 1"},
    "1683.9.12" => {name: "Pedro | Bragança", lived: "1648.4.26 - 1706.12.9", father: "João 1"},
    "1706.12.9" => {name: "João | Bragança", lived: "1689.10.22 - 1750.7.31", father: "Pedro 1"},
    "1750.7.31" => {name: "José | Bragança", lived: "1714.6.6 - 1777.2.24", father: "João 2"},
    "1777.2.24" => {name: "Maria | Bragança", lived: "1734.12.17 - 1816.3.20", father: "José 1", female: true},
    "1816.3.20" => {name: "João | Bragança", lived: "1767.5.13 - 1826.3.10", mother: "Maria 1"},
  ...
  k_frisia: {
    "1815.3.16" => {name: "Willem | Oranje-Nassau", lived: "1772.8.24 - 1843.12.12"},
    "1840.10.7" => {name: "Willem | Oranje-Nassau", father: "Willem 1", lived: "1792.12.6 - 1849.3.17"},
    "1849.3.17" => {name: "Willem | Oranje-Nassau", father: "Willem 2", lived: "1817.2.19 - 1890.11.23"},
    "1890.11.23" => {name: "Wilhelmina | Oranje-Nassau", father: "Willem 3", female: true, lived: "1880.8.31 - 1962.11.28"},
    "1948.9.4" => {name: "Juliana | Oranje-Nassau", mother: "Wilhelmina 1", female: true, lived: "1909.4.30 - 2004.3.20"},
    "1980.4.30" => {name: "Beatrix | Oranje-Nassau", mother: "Juliana 1", female: true, lived: "1938.1.31 -"},
    "2013.4.30" => {name: "Willem-Alexander | Oranje-Nassau", mother: "Beatrix 1", lived: "1967.4.27-"},
  },
  d_flanders: {
    belgium_independence: {name: "Leopold | Sachsen-Coburg und Gotha", lived: "1790.12.16 - 1865.12.10"},
    "1865.12.10" => {name: "Leopold | Sachsen-Coburg und Gotha", father: "Leopold 1", lived: "1835.4.9 - 1909.12.17"},
    # nephew of Leopold 2, can't model that yet
    "1909.12.17" => {name: "Albert | Sachsen-Coburg und Gotha", lived: "1875.4.8 - 1934.2.17"},
    "1934.2.17" => {name: "Leopold | Sachsen-Coburg und Gotha", father: "Albert 1", lived: "1901.11.3 - 1983.9.25"},
    "1951.7.17" => {name: "Baudouin | Sachsen-Coburg und Gotha", father: "Leopold 3", lived: "1930.9.7 - 1993.7.31"},
    "1993.7.31" => {name: "Albert | Sachsen-Coburg und Gotha", father: "Leopold 3", lived: "1934.6.6 -"},
    "2013.7.21" => {name: "Philippe | Sachsen-Coburg und Gotha", father: "Albert 2", lived: "1960.4.15-"},
  },
  d_luxembourg: {
    "1890.11.23" => {
